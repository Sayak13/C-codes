...
void prime(int w)
{
    ...
    int i,z, j, isPrime, a[100],k=1,l=1;
...
{
    if (C_a[0] == 0 || B_a[0] == 0 || C_a[1] == 0 || B_a[1] == 0 || C_a[2] == 0 || B_a[2] == 0 ||C_a[0] >= 32 || B_a[0] >= 32 || C_a[1] >= 13 || B_a[1] >= 13 || B_a[2]>=C_a[2])
    {
        printf("\nError");
        exit(0);
    }
